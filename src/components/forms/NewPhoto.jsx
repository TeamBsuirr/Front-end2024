...
export default function NewPhoto({ objectOfPhoto, isUpdate }) {
    ...
    const validateInput = () => {
        ...
        if (!formData.image || formData.image.length === 0) {
            isValid = false;
            notification.error({
                message: t("errors.front-end.add-story.no-files"),
            });
        } else {
            // Проверка типа файла
            ...
            if (!isUpdate) {
                searchService
                    ...
                    .then((response) => {
                        ...
                        if (response.status === 201 || !response.status)
                            notification.success({
                                message: t(
                                    "errors.front-end.add-story.success-photo",
                                ),
                            });
                        return response;
                    })
                    .catch((error) => {
                        ...
                        notification.error({
                            message: t(
                                "errors.front-end.add-story.error-receive",
                            ),
                            description:
                                t(
                ...
                <div className="container-form-new-photo">
                    <div className="container-inputs-form-new-photo">
                        <div className="container-inputs-form-inputs">
                            <InputPhoto
                                placeholder={t(
                                    "add-photo.placeholder.photo-load",
                                )}
                ...
                <div className="container-desctription-inputs-new-photo">
                    <div className="container-section-photo-description">
                        <div className="container-span-for-inputs-new-photo">
                            <span>{t("add-photo.placeholder.tip")}</span>
                        </div>
                        <div className="container-inputs-new-photo">
                            ...
                            <InputShortDescription
                                ...
                                shortValue={formData.description}
                            />
                        </div>
                    </div>
                </div>
