...
export default function MapUzniki({
    ...
    // useEffect(() => {
    //     // Устанавливаем состояние загрузки в true перед загрузкой карты
    //     setLoading(true);

    //     // Как только карта и все маркеры загружены, изменяем состояние загрузки
    //     const timer = setTimeout(() => {
    //         setLoading(false); // Ожидаем загрузки всех маркеров
    //     }, 1000); // Предполагаем, что за 1 секунду все данные подгрузятся
