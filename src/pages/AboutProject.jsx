    ...
    <div className="about-project">
      ...
      <div className="container-1">
        <div className="mid">
          ...
          <span className="container-2-sub-1"></span><span></span>
          </p>
          <div className="line">
          </div>
          ...
          <div className="container-4">
            ...
            <div className="partners">
              ...
              <div className="container-5">
                <div className="unnamed-1">
                </div>
              </div>
              <div className="container-4">
              </div>
              <div className="bsuir">
                <img className="container-8" src="assets/vectors/Image34_x2.svg" />
              </div>
            </div>
          </div>
          <div className="container">
            <span className="container-13">
            Ⓒ Узники Беларуси, 2024
            </span>
      ...
      <div className="header">
        ...
        <div className="lang">
          <div className="lang-11">
            <img className="container-20" src="assets/vectors/Image6_x2.svg" />
          </div>
